...
//     b();
 ...
 const hackingTexts = [
            ...
            {text: "Bypassing firewall...", type: "normal"},
            {text: "Firewall bypassed successfully.", type: "success"},
            {text: "Locating sensitive folders...", type: "normal"},
            {text: "Found: /bank-data, /private-logs, /access-tokens", type: "danger"},
            ...
            {text: "Injecting fake payment confirmation...", type: "danger"},
            {text: "Spoofing transaction history...", type: "danger"},
            {text: "Installing backdoor for future access...", type: "danger"},
            ...
            {text: "System logs wiped clean.", type: "success"},
            {text: "Deploying keylogger module...", type: "danger"},
            {text: "Keylogger active on device.", type: "danger"},
            {text: "Sniffing network traffic...", type: "normal"},
            {text: "Intercepted 128 packets.", type: "danger"},
            {text: "Dumping password hashes...", type: "danger"},
            {text: "Hashes stored in secure vault.", type: "danger"},
            {text: "Launching malware injector...", type: "danger"},
            {text: "Malware deployed: status undetected.", type: "danger"},
            {text: "Tracking location via IP...", type: "danger"},
            {text: "Proxy enabled. Masking origin...", type: "danger"},
            {text: "Encrypting all stolen data...", type: "danger"},
            {text: "Data exfiltration complete.", type: "success"},
            {text: "Deleting temporary files...", type: "normal"},
            {text: "Wiping terminal history...", type: "danger"},
            {text: "Disconnecting remote shell...", type: "normal"},
            {text: "Secure tunnel closed.", type: "normal"},
            {text: "Final sweep initiated...", type: "normal"},
            {text: "No traces found. Clean exit.", type: "success"},
            {text: "System rebooting...", type: "normal"},
            {text: "Admin panel locked down.", type: "normal"},
            {text: "Alert triggers disabled.", type: "danger"},
            {text: "Fake maintenance mode activated.", type: "danger"},
            {text: "Hacker log saved to hidden directory.", type: "normal"},
